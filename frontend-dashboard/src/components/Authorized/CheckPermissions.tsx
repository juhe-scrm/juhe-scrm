...
/**
 * @en-US
 * General permission.ts check method
 * Common check permissions method
 * @param {Permission judgment} authority
 * @param {Your permission.ts | Your permission.ts description} currentAuthority
 ...
 * @param { 你的权限 | Your permission.ts description } currentAuthority
...
const checkPermissions = <T, K>(
  ...
  // No judgment permission.ts. View all by default
